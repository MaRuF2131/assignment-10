export default () => {
    ...
    return (
        <footer className="text-gray-300 bg-white/10 px-4 py-5 max-w-screen-xl mx-auto md:px-8">
            <div className="gap-6 justify-between md:flex">
                ...
                <div className="flex-1 mt-10 space-y-6 items-center justify-between flex md:space-y-0 md:mt-0">
                    {
