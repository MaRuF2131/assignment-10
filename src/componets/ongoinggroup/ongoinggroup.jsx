...
useEffect(()=>{
  const  allgroup=async()=>{
    const result =await fetch('https://express-server-for-practice.vercel.app/ongoinggroup');
...
return (
     <div className="p-6 h-full w-full max-w-screen-xl grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
       <div className="col-span-full text-center">
              <h2 className="text-3xl md:text-4xl font-bold mb-6">Ongoing Hobby Groups</h2>
              <p className="text-lg text-gray-300 mb-12">Explore some of ongoing and exciting groups in our community.</p>
       </div>
      {groups.map((group) => (
        <div
          key={group.id}
